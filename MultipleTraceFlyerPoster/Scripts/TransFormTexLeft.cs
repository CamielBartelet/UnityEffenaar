...
public class TransFormTexLeft : MonoBehaviour
{
    ...
    {   yield return new WaitForSeconds(0.5f);
        ...
        startPosLeft = rightObject.transform.localPosition;
        endPosLeft = rightObject.transform.localPosition + Vector3.up * distance2;
    ...
    public IEnumerator ContinueLerping()
    {
        ...
        startPosLeftContinue = endPosLeft;
        endPosLeftContinue = endPosLeft + Vector3.right * distance3 + Vector3.forward * distance4;
    }
    ...
    {          
        ...
        rightObject.transform.localPosition = Vector3.Lerp(startPosLeft, endPosLeft, Perc);
        ...
        rightObject.transform.localPosition = Vector3.Lerp(startPosLeftContinue, endPosLeftContinue, PercMore);
    ...
    {  
        rightObject.transform.localPosition = startPosLeft;
    }
